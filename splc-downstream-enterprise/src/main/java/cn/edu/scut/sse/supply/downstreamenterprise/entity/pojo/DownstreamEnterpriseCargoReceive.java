...
@Entity
@Table(name = "downstream_enterprise_cargo_receive", schema = "supply_chain", catalog = "")
public class DownstreamEnterpriseCargoReceive {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        DownstreamEnterpriseCargoReceive that = (DownstreamEnterpriseCargoReceive) o;
