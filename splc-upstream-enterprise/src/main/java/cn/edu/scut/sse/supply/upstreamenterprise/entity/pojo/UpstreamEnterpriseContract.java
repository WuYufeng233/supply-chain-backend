...
@Entity
@Table(name = "upstream_enterprise_contract", schema = "supply_chain", catalog = "")
public class UpstreamEnterpriseContract {
    private Integer fid;
    private String hash;
    ...
    public boolean equals(Object o) {
        ...
        UpstreamEnterpriseContract that = (UpstreamEnterpriseContract) o;
