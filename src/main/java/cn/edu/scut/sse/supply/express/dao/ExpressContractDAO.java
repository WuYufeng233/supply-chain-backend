...
public class ExpressContractDAO {
    ...
    private final int ENTERPRISE_CODE = 2001;
    ...
    public ResponseResult saveContractToFisco(ExpressContract expressContract, String sponsorSignature) throws Exception {
        ...
        BigInteger contractId = new BigInteger(String.valueOf(ENTERPRISE_CODE).concat(String.valueOf(expressContract.getFid())));
