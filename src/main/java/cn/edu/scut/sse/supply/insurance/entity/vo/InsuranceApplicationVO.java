...
public class InsuranceApplicationVO {
    private Integer fid;
    ...
    public static InsuranceApplicationVO from(InsuranceApplication application) {
        InsuranceApplicationVO vo = new InsuranceApplicationVO();
