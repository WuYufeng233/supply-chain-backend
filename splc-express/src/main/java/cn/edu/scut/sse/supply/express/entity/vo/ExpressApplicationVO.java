package cn.edu.scut.sse.supply.express.entity.vo;
...
public class ExpressApplicationVO {
    private Integer fid;
    ...
    public static ExpressApplicationVO from(ExpressApplication application) {
        ExpressApplicationVO vo = new ExpressApplicationVO();
